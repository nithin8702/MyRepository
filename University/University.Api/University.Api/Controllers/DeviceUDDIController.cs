...
{
    public class DeviceUDDIController : UnSecuredController
    {
        public HttpResponseMessage Put(ApiViewModel apiViewModel)
        {
            //_logger.Info("DeviceUDDI HttpPUt - Called");
                ...
                if (apiViewModel.HasValue())
                {
                    ...
                    if (tenant != null)
                    {
                        ...
                        if (currentUser.HasValue())
                        {
                            ...
                            apiDataLogId = DataLog.LogData(currentUser, VerbConstants.Put, "DeviceUDDI", data);
